      ...
      <div className="student-list__info">
        <div className="student-list__header-container">
          ...
          <div onClick={() => toggleAccordion(student.id)} key={student.id}>
            <span className="student-list__icon">
              {isActive === student.id ? "-" : "+"}
            </span>
          </div>
        </div>
        ...
        <p className="student-list__text">
          Average: {handleAverageGrade(student.grades)}%
        </p>
        <Grades
          isActive={isActive}
        ...
        />
        <Tags tags={tags} studentId={student.id} setTags={setTags} />
      </div>
    </div>
  );
}
